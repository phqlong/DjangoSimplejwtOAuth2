...
SECRET_KEY = 'django-insecure-uuy3k5h0by!v_+uc&1p&58_sh_zr%k!jjn2-#ujhe^+^q=a45w'
...
INSTALLED_APPS = [
    ...
    # CORS
    'corsheaders',
    # For running SSL Server
    'sslserver',
    # Blacklist for only use most recent refresh token
...
SECRET_FACEBOOK_STATE = env.str('SECRET_FACEBOOK_STATE')
